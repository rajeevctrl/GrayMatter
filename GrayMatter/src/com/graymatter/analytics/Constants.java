...
public class Constants {
	...
	public static String[] ENGLISH_STOPWORDS = { "without", "see", "unless",
		"due", "also", "must", "might", "like", "will", "may", "can",
		"much", "every", "the", "in", "other", "this", "the", "many",
		...
		"Which", "While", "Who", "Who’s", "Whom", "Why", "Why’s", "With",
		"Won’t", "Would", "Wouldn’t", "You", "You’d", "You’ll", "You’re",
		"You’ve", "Your", "Yours", "Yourself", "Yourselves", "FW:", "fw:", "RE:","re:" };
	
	public static String[] SPECIAL_CHARACTERS = { "]", "[", "}", "{", "<", ">",
			"?", "\"", "\\", "/", ")", "(", "!", "@", "#", "$", "%", "^", "&",
			"*", "-","_", "+", "=", ";", ":", "'", "\"", "<", ",", ">", ".", "`", "~" };
	
	public static String[] ESCAPE_CHARACTERS={"\t","\r"};
}
